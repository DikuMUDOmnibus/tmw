...
*/
/* right on, that's why we're using it in FuBaR 1.3.1X ! --Kj */
...
const struct flag_type type_flags[] =
{
    ...
    {	"ranged",		ITEM_RANGED_WEAPON,	TRUE	},
    {   "siege",		ITEM_SIEGE,		TRUE },
    {	"clip",			ITEM_CLIP,		TRUE },
    {	"bullet",		ITEM_BULLET,		TRUE },
    {	"bomb",			ITEM_BOMB,		TRUE },
    {   "mech",			ITEM_MECH, 		TRUE },
    {   "powerarmor",		ITEM_PARMOR,		TRUE },
    {   "vehicle",              ITEM_VEHICLE,           TRUE},
	{	"phone",		ITEM_PHONE,	TRUE},
    {	"",			0,			0	}
};

const struct flag_type movement_flags[] =
{
  { "Rolls", 0, TRUE },
  { "Wheels", 1, TRUE },
  { "Flies", 2, TRUE },
...
const struct flag_type extra_flags[] =
{
    ...
    {   "ammunition",		ITEM_AMMUNITION,	TRUE	},   
    {   "automatic",		ITEM_AUTOMATIC,	TRUE },
    {   "burst", ITEM_BURST, TRUE },
    {	"",			0,			0	}
};
/* FOR NEW FLAGS */
const struct flag_type anti_class_flags[] =
{
    ...
    {   "anti-ninja", 		ITEM_ANTI_NINJA,        TRUE    },
    {   "anti-airkin",          ITEM_ANTI_AIRKIN,       TRUE    },
    {   "anti-earthkin",        ITEM_ANTI_EARTHKIN,     TRUE    },
    {   "anti-firekin",         ITEM_ANTI_FIREKIN,      TRUE    },
    {   "anti-waterkin",        ITEM_ANTI_WATERKIN,     TRUE    },
    {	"",			0,			0	}
};
const struct flag_type anti_race_flags[] =
{
    ...
    {   "anti-kreen",           ITEM_ANTI_KREEN,        TRUE    },
    {   "anti-elemental",       ITEM_ANTI_ELEMENTAL,    TRUE    },
    {	"",			0,			0	}
};
...
const struct flag_type wear_flags[] =
{
    ...
    {   "doublefinger",		ITEM_DOUBLE_FINGER,	TRUE    },
    {   "doubleneck",		ITEM_DOUBLE_NECK,	TRUE	},
    {   "doublewrist",		ITEM_DOUBLE_WRIST,	TRUE    },
    {   "doubleear",		ITEM_DOUBLE_EAR,	TRUE	},
    {   "doubleankle",		ITEM_DOUBLE_ANKLE,	TRUE	},
    {	"",			0,			0	}
};
...
const struct flag_type apply_flags[] =
{
    ...
    {	"will power",			APPLY_MANA,		TRUE	},
    {   "blood",                APPLY_BP,               TRUE    },
    {   "anti-disarm",          APPLY_ANTI_DIS,         TRUE    },
    {	"hp",			APPLY_HIT,		TRUE	},
    {	"move",			APPLY_MOVE,		TRUE	},
    {	"credits",			APPLY_GOLD,		TRUE	},
...
const struct flag_type wear_loc_flags[] =
{
    ...
    {	"third",	WEAR_WIELD_3,	TRUE	},
    {	"",		0,		0	}
};

const struct flag_type bionic_loc_flags[] =
{
    {   "none",	BIONIC_NONE,	TRUE	},
    {   "leye",		BIONIC_EYE_L,	TRUE	},
    {	"reye",		BIONIC_EYE_R,	TRUE	},
    {	"body",			BIONIC_BODY,	TRUE	},
    {	"larm",		BIONIC_ARM_L,	TRUE	},
    {	"rarm",		BIONIC_ARM_R,	TRUE	},
    {	"lhand",		BIONIC_HAND_L,	TRUE	},
    {	"rhand",		BIONIC_HAND_R,	TRUE	},
    {	"lleg",		BIONIC_LEG_L,	TRUE	},
    {	"rleg",		BIONIC_LEG_R,	TRUE	},
    {	"imp1",		BIONIC_IMPLANT1,TRUE	},
    {	"imp2",		BIONIC_IMPLANT2,TRUE	},
    {	"imp3",		BIONIC_IMPLANT3,TRUE	},
    {	"imp4",		BIONIC_IMPLANT4,TRUE	},
    {	"imp5",		BIONIC_IMPLANT5,TRUE	},
    {	"imp6",		BIONIC_IMPLANT6,TRUE	},
    {	"imp7",		BIONIC_IMPLANT7,TRUE	},
    {	"imp8",		BIONIC_IMPLANT8,TRUE	},
    {	"imp9",		BIONIC_IMPLANT9,TRUE	},
    {	"imp10",		BIONIC_IMPLANT10,TRUE	},
    {	"mem1",		BIONIC_MEMORY1,	TRUE	},
    {	"mem2",		BIONIC_MEMORY2,	TRUE	},
    {	"mem3",		BIONIC_MEMORY3, TRUE	},
    {	"mem4",		BIONIC_MEMORY4, TRUE	},
    {	"",			0			}
};

const struct flag_type mecharmor_flags[] =
{
 { "iron", 0,		TRUE },
 { "steel", 1,		TRUE },
 { "titanium", 2,	TRUE },
