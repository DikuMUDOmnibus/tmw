...
void do_headbutt( CHAR_DATA *ch, char *argument )
{
   ...
   {
   case CLASS_MAGE:
   case CLASS_HEALER:      timer = 240;  break;
   case CLASS_SPY:         timer = 180;  break;
   case CLASS_SOLDIER:   timer = 120;  break;
   case CLASS_PSIONICIST:
   case CLASS_CYBORG:       timer = 240;  break;
   case CLASS_PILOT:
   case CLASS_GENEMASTER:
   case CLASS_TECH:
