...
const	struct	guild_data	guild_table	[]		=
{
  ...
  {     "1045",         "Bloustone",      AT_YELLOW,      GUILD_NORMAL },
...
/*{     "name",      "colorname",                      vnum,         qp,     level  }*/
  ...
  {     "pocket watch",  "&YP&Oo&Yc&Ok&Ye&Ot &YW&Oa&Yt&Oc&Yh",          2458,   750,  170   },
  {     "",                              0,           0,       0      }
};
...
{
    {   0,   
	{ MAG, HLR, SPY, GLD, PSI, CYB, PIL, GNM, MUT,
	  VAM }
    },
...
/*  {   "Who", "Long", PRIME_STAT, START_WEAPON,
	GUILD, PRAC_%, tach0_0, tach0_97, HP_MIN, HP_MAX, GETS_MANA,
      { HUM, ELF, DWA, PIX, HLF, DRW, ELD, LIZ, 
	DEM, GHL, ILL, TRO, SHD, TBX, KRN, EAL },
      { OPR, MDC, ROG, SDR, WTH, AGT, PIL, HCK, TCH,
	VAM }
    ...
    {
	"Opr", "Operator",  APPLY_INT,  OBJ_VNUM_SCHOOL_DAGGER,
	3018,  95,  18,  -6,   6,  8, FALSE,
/* race to base class */
      { TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE,
	TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE },
/* can class multiclass with this class? */
      { FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE,
	TRUE },
/* Can class wield this type of weapon? */
      { TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE,
        TRUE, TRUE, TRUE, TRUE, TRUE },  
/* class prerequisites, new class system */
      { 0, 0, 0, 10, 0, 0, 0, 0, 0, 0 }
    },

    {
	"Mdc", "Medic",  APPLY_WIS,  OBJ_VNUM_SCHOOL_MACE,
	3003,  95,  18,  -10,  7,  10, FALSE,
      { TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE,
	TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE },
    ...
    {
	"Sdr",  "Soldier", APPLY_STR,  OBJ_VNUM_SCHOOL_SWORD,
    ...
    {
        "Wth",  "Wraith", APPLY_WIS,  OBJ_VNUM_SCHOOL_DAGGER,
    ...
    {
	"Agt", "Agent",  APPLY_WIS,  OBJ_VNUM_SCHOOL_MACE,
    ...
    {
	"Pil",  "Pilot", APPLY_CON,  OBJ_VNUM_SCHOOL_SWORD,
	3022,  90,  18,  -18,  14, 18, FALSE,
      { FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,
	FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE },
	...
	TRUE },
      { TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE,
        TRUE, TRUE, TRUE, TRUE, TRUE },
      { 10, 0, 0, 30, 0, 0, 0, 0, 0, 0 }  
    },

    {
	"Hck",  "Hacker", APPLY_INT,  OBJ_VNUM_SCHOOL_SWORD,
	3022,  90,  18,  -16,  10, 16, FALSE,
      { FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,
	FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE },
    ...
    {
	"Tch",  "Technician", APPLY_DEX,  OBJ_VNUM_SCHOOL_DAGGER,
	3028,  90,  18,  -14,  9,  13, FALSE,
      { FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,
	FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE },
...
*/
...

  {
    ...
    NULL,			20,	12,
    "&gacid blast&X",		"!Acid Blast!", "", FALSE, 6, SLOT(0)
  },

  {
    "animate dead",
    { L_APP, 33, L_APP, L_APP, L_APP, L_APP, L_APP, 120, L_APP, 67,
      L_APP,      L_APP,      L_APP },
    spell_animate,  	TAR_OBJ_INV,		POS_STANDING,
    NULL,			100,	24,
    "",			"!Animate Dead!", "", FALSE, 5, SLOT(0)
  },

  {
    "armor",
    { 13, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
...

  {
    ...
    NULL,			50,	12,
    "",			"!Astral Walk!", "", FALSE, 7, SLOT(0)
  },

/*
    "barkskin"
    { 200, 145, 203, L_APP, 18, L_APP, 15, 158, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
...
*/
  ...
  {
    "bless",
    { L_APP, 5, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
  ...
  {
    "blindness",
    { 18, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
...

  {
    ...
    NULL,			15,	12,
    "&rbu&Yrni&Wng &rh&Oa&Yn&Wds&X","!Burning Hands!", "", FALSE, 2, SLOT(0)
  },

  {
    "call lightning",
    { 103, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 167, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_call_lightning,	TAR_IGNORE,		POS_FIGHTING,
    NULL,			15,	12,
    "&Blightning bolt&X",	"!Call Lightning!", "", FALSE, 2, SLOT(0)
  },

  {
    "cause critical",
    { L_APP, 19, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_cause_critical,	TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    NULL,			20,	12,
    "spell",		"!Cause Critical!", "", FALSE, 4, SLOT(0)
  },

  {
    ...
    NULL,			15,	12,
    "&wspell&X",		"!Cause Light!", "", FALSE, 1, SLOT(0)
  },

  {
    "cause serious",
    { L_APP, 13, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_cause_serious,	TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    NULL,			17,	12,
    "&wspell&X",		"!Cause Serious!", "", FALSE, 2, SLOT(0)
  },

  {
    "change sex",
    { 40, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
  ...
  {
    "charm person",
    {  24, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 4, L_APP, 19,
      L_APP,      L_APP,      L_APP },
  ...
  {
    "chill touch",
    { 5, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_chill_touch,	TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    NULL,			15,	12,
    "&Cch&wil&Cli&wng &Cto&wu&Cch&X",
    "You feel less cold.",
    "$n looks warmer.", TRUE, 4, SLOT(6)
  },
...
FALSE, 4, SLOT(0)
  ...
  {
    "continual light",
    { 6, 7, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_continual_light,      TAR_IGNORE,             POS_STANDING,
    NULL,			7,	12,
    "",			"!Continual Light!", "", FALSE, 1, SLOT(0)
  },

  {
    "control weather",
    { 111, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_control_weather,      TAR_IGNORE,             POS_STANDING,
    NULL,			25,	12,
    "",			"!Control Weather!", "", FALSE, 2, SLOT(0)
  },

  {
    "create food",
    { 114, 12, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_create_food,	TAR_IGNORE,		POS_STANDING,
    NULL,			5,	12,
    "",			"!Create Food!", "", FALSE, 1, SLOT(0)
  },

  {
    "create spring",
    { 32, 56, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_create_spring,	TAR_IGNORE,		POS_STANDING,
    NULL,			20,	12,
    "",			"!Create Spring!", "", FALSE, 1, SLOT(0)
  },

  {
    "create water",
    { L_APP, 7, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_create_water,	TAR_OBJ_INV,		POS_STANDING,
    NULL,			5,	12,
    "",			"!Create Water!", "", FALSE, 1, SLOT(0)
  },

  {
    "cure blindness",
    { L_APP, 30, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,       L_APP },
    spell_cure_blindness,	TAR_CHAR_DEFENSIVE,	POS_FIGHTING,
    NULL,			5,	12,
    "",			"!Cure Blindness!", "", FALSE, 4, SLOT(0)
  },

  {
    "cure critical",
    { L_APP, 17, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_cure_critical,	TAR_CHAR_DEFENSIVE,	POS_FIGHTING,
    NULL,			20,	12,
    "",			"!Cure Critical!", "", FALSE, 3, SLOT(0)
  },
...

  {
    ...
    NULL,			15,	12,
    "",			"!Cure Serious!", "", FALSE, 2, SLOT(0)
  },

  {
    "curse",
    { 3, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 38, 
      L_APP,      L_APP,      L_APP },
...

  {
   "detect evil",
    ...
    "$n's vision is restored to normal.", TRUE, 1, SLOT(8)
  },

 {
    "detect hidden",
    { L_APP, L_APP, 1, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_detect_hidden,	TAR_CHAR_SELF,		POS_STANDING,
    NULL,			5,	12,
    "",	"You feel less aware of your suroundings.", 
    "$n feels less aware of $s surroundings.", TRUE, 5, SLOT(9)
  },

  {
    ...
    "$n's vision returns to normal.", TRUE, 8, SLOT(10)
  },

  {
    "detect magic",
    {     6, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_detect_magic,	TAR_CHAR_SELF,		POS_STANDING,
    NULL,			5,	12,
    "",			"The detect magic wears off.", 
    "$n's vision returns to normal.", TRUE, 1, SLOT(11)
  },

  {
    "detect poison",
    { L_APP, 11, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_detect_poison,	TAR_OBJ_INV,		POS_STANDING,
    NULL,			5,	12,
    "",			"!Detect Poison!", "", TRUE, 1, SLOT(12)
  },

  {
    "dispel evil",
    { 24, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_dispel_evil,	TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    NULL,			15,	12,
    "dispel &zevil&X",		"!Dispel Evil!", "", FALSE, 3, SLOT(0)
  },
...

  {
    ...
    NULL,			15,	12,
    "&Oearthquake&X",		"!Earthquake!", "", FALSE, 2, SLOT(0)
  },

  {
    ...
    NULL,			100,	24,
    "",			"!Enchant Weapon!", "", FALSE, 4, SLOT(0)
  },

  {
    "energy drain",
    { 23, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,       L_APP,      L_APP },
    spell_energy_drain,	TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    NULL,			35,	12,
    "&zene&wrgy d&Wrain&X",	"!Energy Drain!", "", FALSE, 3, SLOT(0)
  },

  {
    "faerie fire",
    { 4, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
  ...
  {
    "faerie fog",
    {  99, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
       L_APP,      L_APP,     L_APP },
    spell_faerie_fog,	TAR_IGNORE,		POS_STANDING,
    NULL,			12,	12,
    "faerie fog",		"!Faerie Fog!", "", FALSE, 4, SLOT(0)
  },
 
  {
    ...
    NULL,			15,	12,
    "&Rfireball&X",		"!Fireball!", "", FALSE, 3, SLOT(0)
  },
...

  {
    ...
    NULL,			20,	12,
    "&rflame&Rstrike",		"!Flamestrike!", "", FALSE, 2, SLOT(0)
  },

  {
    "fly",
    {     9, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 3,
  ...
  {
    "gate",
    { 3, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,179,
      L_APP,      L_APP,      L_APP },
  ...
  {
    "giant strength",
    { 7, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,       L_APP },
    spell_giant_strength,	TAR_CHAR_DEFENSIVE,	POS_STANDING,
    NULL,			20,	12,
    "",
    "You feel weaker.",
    "$n no longer looks so mighty.", TRUE, 4, SLOT(16)
  },

{
    ...
    "$n looks a bit duller.", TRUE, 4, SLOT(16)
  },

  {
    ...
    NULL,			25,	8,
    "",			"!GOODBERRY!", "", FALSE, 1, SLOT(0)
  },

  {
    "harm",
    { 34, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_harm,		TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    NULL,			35,	12,
    "&zharm &wspell&X",		"!Harm!", "", FALSE, 2, SLOT(0)
  },

  {
    "heal",
    { L_APP, 24, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_heal,		TAR_CHAR_DEFENSIVE,	POS_FIGHTING,
    NULL,			50,	12,
    "",			"!Heal!", "", FALSE, 10, SLOT(0)
  },

  {
    "iceshield",
    { 150, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
...

  {
    ...
    NULL,			25,	8,
    "&Cicy blast&X",	"!ICESTORM!", "", FALSE, 3, SLOT(0)
  },
...

  {
    ...
    "$n body stops vibrating.", FALSE, 3, SLOT(18)
  },
...
TRUE, 3, SLOT(19)
...

  {
    ...
    "The flames around $n have been extinguished.",TRUE, 3, SLOT(20)
  },
...

  {
    ...
    NULL,			9,	12,
    "",			"!Know Alignment!", "", FALSE, 2, SLOT(0)
  },

  {
    "lightning bolt",
    { 17, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_lightning_bolt,	TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    NULL,			15,	12,
    "&Blightning bolt&X",	"!Lightning Bolt!", "", FALSE, 2, SLOT(0)
  },

  {
    "locate object",
    {     29, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_locate_object,	TAR_IGNORE,		POS_STANDING,
    NULL,			20,	18,
    "",			"!Locate Object!", "", FALSE, 2, SLOT(0)
  },

  {
    ...
    NULL,			15,	12,
    "&Pmag&pic mis&Psile",	"!Magic Missile!", "", FALSE, 1, SLOT(0)
  },
 
  {
    "mana",
    { L_APP, 138, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
  ...
  {
    "mass invis",
    { 35, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_mass_invis,	TAR_IGNORE,		POS_STANDING,
    &gsn_mass_invis,	20,	24,
    "",
    "!Mass Invis!",
    "$n fades into existance.", TRUE, 20, SLOT(22)
  },

  {
    "pass door",
    {    28, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_pass_door,	TAR_CHAR_SELF,		POS_STANDING,
    NULL,			20,	12,
    "",
    "You feel solid again.",
    "$n becomes soild.", TRUE, 8, SLOT(23)
  },

  {
    "aura of peace",
    { 101, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_aura,     	TAR_CHAR_SELF,	POS_STANDING,
    NULL,			100,	12,
    "",
    "The peace aura around your body fades.",
    "The peace aura around $n fades.", FALSE, 7, SLOT(24)
  },

  {
    ...
    NULL,			200,	24,
    "",			"!Permenancy!", "", FALSE, 7, SLOT(0)
  },

  {
    "poison",
    { 89, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
     L_APP,      L_APP,      L_APP },
    spell_poison,		TAR_CHAR_OFFENSIVE,	POS_STANDING,
    &gsn_poison,		10,	12,
    "&Gp&go&Gi&gs&Go&gn",
    "You feel less sick.",
    "$n looks better.", TRUE, 3, SLOT(25)
  },
  ...
  {
    "refresh",
    { L_APP,  3, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_refresh,		TAR_CHAR_DEFENSIVE,	POS_STANDING,
    NULL,			12,	18,
    "refresh",		"!Refresh!", "", FALSE, 2, SLOT(0)
  },

  {
    "remove curse",
    { L_APP, 22, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_remove_curse,	TAR_CHAR_DEFENSIVE,	POS_STANDING,
    NULL,			5,	12,
    "",			"!Remove Curse!", "", FALSE, 3, SLOT(0)
  },

  {
    ...
    "The white aura around $n's body vanishes.", TRUE, 15, SLOT(27)
  },

  {
    ...
    "$n's vision returns to normal.", TRUE, 2, SLOT(0)
  },
...
FALSE, 2, SLOT(0)
  ...
  {
    "sleep",
    {    23, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 46,
      L_APP,      L_APP,      L_APP },
    spell_sleep,		TAR_CHAR_OFFENSIVE,	POS_STANDING,
    &gsn_sleep,		15,	12,
    "",			"You feel less tired.", 
    "$n looks much more refreshed.", TRUE, 5, SLOT(30)
  },

  {
    ...
    NULL,			100,	24,
    "",			"!Spell Bind!", "", FALSE, 4, SLOT(0)
  },

  {
    "stone skin",
    { 27, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
  ...
  {
    "summon",
    {  45, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_summon,		TAR_IGNORE,		POS_STANDING,
    NULL,			50,	12,
    "",			"!Summon!", "", FALSE, 5, SLOT(0)
  },
 ...
 */
  {
    ...
    NULL,			50,	12,
    "&gblast of &Gacid&X",	"!Acid Breath!", "", FALSE, 10, SLOT(0)
  },

  {
    ...
    NULL,			50,	12,
    "&Rblast of &rflame&X",	"!Fire Breath!", "", FALSE, 10, SLOT(0)
  },

  {
    ...
    NULL,			50,	12,
    "&Cblast of &bfrost",	"!Frost Breath!", "", FALSE, 12, SLOT(0)
  },

  {
    ...
    NULL,			50,	12,
    "&zblast of &wgas",		"!Gas Breath!", "", FALSE, 10, SLOT(0)
  },

  {
    ...
    NULL,			50,	12,
    "&cblast of &Blightning",	"!Lightning Breath!", "", FALSE, 10, SLOT(0)
  },
/*
  {MAG,THI,CLE,WAR,PSY,DRU,RAN,PAL,BAR,VAM,
   NEC,WWF,MNK,NIN,AIK,EAK,FIK,WTK,PRO,PRO,PRO}
*/
/* XOR */
  {
    "summon swarm",
 ...
 */
  {
    "backstab",
    { L_APP, L_APP, 9, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_STANDING,
    &gsn_backstab,		0,	24,
    "backstab",		"!Backstab!", "", FALSE, 20, SLOT(0)
  },

  {
    ...
    spell_null,		TAR_IGNORE,		POS_STANDING,
    &gsn_backstab_2,		0,	24,
    "backstab",		"!Double Backstab!", "", FALSE, 30, SLOT(0)
  },
...

  {
    ...
    &gsn_bash,		0,	24,
    "bash",			"!Bash!", "", FALSE, 2, SLOT(0)
  },

  {
    "disarm",
    { L_APP, L_APP, L_APP, 4, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_FIGHTING,
    &gsn_disarm,		0,	24,
    "",			"!Disarm!", "", FALSE, 8, SLOT(0)
  },

  {
    "dodge",
    { L_APP, L_APP,  4, 5, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_FIGHTING,
    &gsn_dodge,		0,	 0,
    "",			"!Dodge!", "", FALSE, 5, SLOT(0)
  },

  {
    "dual",
    { L_APP, L_APP, 21,  14, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,	POS_RESTING,
    &gsn_dual,		0,	 0,
    "",			"!DUAL!", "", FALSE, 8, SLOT(0)
...

  {
    ...
    "",			"!Enhanced Damage!", "", FALSE, 10, SLOT(0)
  },

  {
    "enhanced damage two",
    { L_APP, L_APP, L_APP, 20, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_FIGHTING,
    &gsn_enhanced_two,	0,	 0,
    "",			"!Enhanced Damage Two!", "", FALSE, 15, SLOT(0)
  },

  {
    "enhanced hit",
    { L_APP, L_APP, L_APP, 15, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP, L_APP, L_APP },
    spell_null,		TAR_IGNORE,		POS_FIGHTING,
    &gsn_enhanced_hit,	0,	 0,
    "",			"!Enhanced Hit!", "", FALSE, 10, SLOT(0)
  },
...

  {
    ...
    "",			"!Fifth Attack!", "", FALSE, 14, SLOT(0)
  },

  {
    "fourth attack",
    { L_APP, L_APP, L_APP, 23, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_FIGHTING,
    &gsn_fourth_attack,	0,	 0,
    "",			"!FOURTH Attack!", "", FALSE, 12, SLOT(0)
  },

  {
    "hide",
    { L_APP, L_APP,     4, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_RESTING,
    &gsn_hide,		0,	12,
    "",
    "You are no longer so difficult to see.",
    "$n has stopped hiding.", FALSE, 5, SLOT(33)
  },

  {
    "iron grip",
    { L_APP, L_APP, L_APP, 19, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,   	 	POS_STANDING,
    &gsn_grip,		0,	 8,
    "",
    "You loosen your hold on your weapon.",
    "$n has loosened $s hold on $s weapon.", FALSE, 5, SLOT(34)
  },

  {
    ...
    spell_null,		TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    &gsn_flury,		0,	 50,
    "flury",			"!flury!", "", FALSE, 15, SLOT(0)
  },

  {
    "kick",
    { L_APP, L_APP,  50,  10, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    &gsn_kick,		0,	 8,
    "kick",			"!Kick!", "", FALSE, 5, SLOT(0)
  },

  {
    ...
    spell_null,		TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    &gsn_high_kick,		0,	 10,
    "high kick",  "!High Kick!", "", FALSE, 5, SLOT(0)
  },

  {
    ...
    spell_null,		TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    &gsn_jump_kick,		0,	 20,
    "jump kick",  "!Jump Kick!", "", FALSE, 5, SLOT(0)
  },

  {
    ...
    spell_null,		TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    &gsn_spin_kick,		0,	 25,
    "spin kick",  "!Spin Kick!", "", FALSE, 7, SLOT(0)
  },

  {
    "parry",
    { L_APP, L_APP, 5, 6, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_FIGHTING,
    &gsn_parry,		0,	 0,
    "",			"!Parry!", "", FALSE, 8, SLOT(0)
  },

  {
    "peek",
    { L_APP, L_APP, 23, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_STANDING,
    &gsn_peek,		0,	 0,
    "",			"!Peek!", "", FALSE, 9, SLOT(0)
  ...
  {
    "pick lock",
    { L_APP, L_APP,  5, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_STANDING,
    &gsn_pick_lock,		0,	12,
    "",			"!Pick!", "", FALSE, 4, SLOT(0)
  ...
  {
    "poison weapon",
    { L_APP, L_APP, 43, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_OBJ_INV,		POS_STANDING,
    &gsn_poison_weapon,	0,	12,
    "poisonous concoction",	"!Poison Weapon!", "", FALSE, 8, SLOT(0)
  },
...

  {
    ...
    "kindey punch",	"!kidney punch!", "", FALSE, 5, SLOT(0)
  },

  {
    ...
    "cross punch",	"!cross punch!", "", FALSE, 5, SLOT(0)
  },

  {
    ...
    "roundhouse",	"!roundhouse punch!", "", FALSE, 6, SLOT(0)
  },

  {
    ...
    "uppercut",	"!uppercut punch!", "", FALSE, 6, SLOT(0)
  },

  {
    "rescue",
    { L_APP, L_APP, L_APP, 7, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_FIGHTING,
    &gsn_rescue,		0,	12,
    "",			"!Rescue!", "", FALSE, 5, SLOT(0)
  },

  {
    "second attack",
    { 12, 17, 11, 3, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_FIGHTING,
    &gsn_second_attack,	0,	 0,
    "",			"!Second Attack!", "", FALSE, 4, SLOT(0)
  },

  {
    "seventh attack",
    { L_APP, L_APP, L_APP, 3, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_FIGHTING,
    &gsn_seventh_attack,	0,	 0,
    "",			"!seventh Attack!", "", FALSE, 18, SLOT(0)
  },

  {
    ...
    "",			"!sixth Attack!", "", FALSE, 16, SLOT(0)
  },

  {
    "sneak",
    { L_APP, L_APP,  22, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_STANDING,
    &gsn_sneak,		0,	12,
    "",			NULL, "", FALSE, 10, SLOT(35)
  },

  {
    ...
    spell_null,		TAR_IGNORE,		POS_STANDING,
    &gsn_steal,		0,	24,
    "",			"!Steal!", "", FALSE, 6, SLOT(0)
  },

  {
    "third attack",
    { L_APP, L_APP, 22, 9, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,		POS_FIGHTING,
    &gsn_third_attack,	0,	 0,
    "",			"!Third Attack!", "", FALSE, 8, SLOT(0)
  },
 ...
 */
  {
    ...
    NULL,                   0,      12,
    "general purpose ammo", "!General Purpose Ammo!", "", FALSE, 1, SLOT(0)
  },

  {
    ...
    NULL,                   0,      12,
    "high explosive ammo",  "!High Explosive Ammo!", "", FALSE, 1, SLOT(0)
  },
...

  {
    ...
    "$n has calmed down.", FALSE, 3, SLOT(36)
  },

  {
    ...
    NULL,                   10,     12,
    "agitation",            "!Agitation!", "", FALSE, 2, SLOT(0)
  },
...

  {
    ...
    NULL,                   5,     12,
    "ballistic attack",     "!Ballistic Attack!", "", FALSE, 1, SLOT(0)
  },
...

  {
    ...
    NULL,                   8,     12,
    "",                     "!Cell Adjustment!", "", FALSE, 4, SLOT(0)
  },

  {
    ...
    spell_null,             TAR_IGNORE,             POS_STANDING,
    &gsn_chameleon,         0,     12,
    "",                     "!Chameleon Power!", "", FALSE, 4, SLOT(38)
  },

  {
    ...
    "The chaos flees from the order around $n.", FALSE, 10, SLOT(39)
  },

  {
    ...
    "$n's sense of battle has diminished.", FALSE, 6, SLOT(40)
  },

  {
    ...
    NULL,                   200,    12,
    "",                     "!Complete Healing!", "", FALSE, 12, SLOT(0)
  },

  {
    ...
    NULL,                   15,     12,
    "tongue of &Rflame&X",      "!Control Flames!", "", FALSE, 2, SLOT(0)
  },

  {
    ...
    NULL,                   5,     12,
    "",                     "!Create Sound!", "", FALSE, 1, SLOT(0)
  },

  {
    "death field",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 1,
      L_APP,      L_APP,      L_APP },
    spell_death_field,      TAR_IGNORE,             POS_FIGHTING,
    NULL,                   200,    18,
    "&zfield of death&X",       "!Death Field!", "", FALSE, 30, SLOT(0)
  },

  {
    ...
    NULL,                   35,     24,
    "&zdet&Rona&rtion",           "!Detonate!", "", FALSE, 3, SLOT(0)
  },

  {
    ...
    NULL,                   150,    18,
    "disintegration",       "!Disintegrate!", "", FALSE, 20, SLOT(0)
  },

  {
    ...
    "$n's image fades as he appears in another spot.", FALSE, 6, SLOT(41)
  },

  {
    ...
    "$n regains control of $s body.", FALSE, 5, SLOT(42)
  },
...

  {
    ...
    "$n looks more confident.", FALSE, 2, SLOT(44)
  },

  {
    ...
    "$n no longer absorbs energy.", FALSE, 4, SLOT(45)
  },
...

  {
    ...
    "$n's skin returns to its normal texture.", FALSE, 3, SLOT(47)
  },

  {
    "heighten senses",
    { L_APP, L_APP, 15, L_APP,  L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,             TAR_CHAR_SELF,          POS_STANDING,
    &gsn_heighten,          0,      0,
    "",                     "Your senses return to normal.", 
    "$n's senses return to normal.", FALSE, 15, SLOT(48)
  },

  {
    ...
    "$n's inertial barrier dissipates.", FALSE, 2, SLOT(49)
  },

  {
    ...
    NULL,                   10,     12,
    "&wmind&Wpower&X",            "!Inflict Pain!", "", FALSE, 2, SLOT(0)
  },
...

  {
    ...
    "$n's mental barrier diminishes.", FALSE, 3, SLOT(52)
  },

  {
    ...
    NULL,                   8,     12,
    "&wmind &Wthrust&X",          "!Mind Thrust!", "", FALSE, 1, SLOT(0)
  },

  {
    ...
    NULL,                   18,     12,
    "&wprojected force&X",      "!Project Force!", "", FALSE, 2, SLOT(0)
  },

  {
    ...
    NULL,                   25,     12,
    "&wpsionic blast&X",        "!Psionic Blast!", "", FALSE, 2, SLOT(0)
  },

  {
    ...
    NULL,                   15,     18,
    "&wpsychic crush&X",        "!Psychic Crush!", "", FALSE, 2, SLOT(0)
  },
...

  {
    ...
    NULL,                   20,      12,
    "",                     "!Psychic Healing!", "", FALSE, 1, SLOT(0)
  },

  {
    ...
    "$n returns from the shadows.", FALSE, 12, SLOT(54)
  },

  {
    ...
    "$n stops sharing $m strength.", FALSE, 2, SLOT(55)
  },

  {
    ...
    "$n doesn't feel very protected.", FALSE, 1, SLOT(56)
  },

  {
    ...
    NULL,                   75,     24,
    "&zultr&wabl&Wast&X",		"!Ultrablast!" , "", FALSE, 10,
SLOT(0)
  },
 ...
 */
...

  {
    ...
    "$n's mind becomes more vulnerable.", FALSE, 4, SLOT(57)
  },
 ...
 */
  {
    "patch",
    { L_APP, L_APP, L_APP, 26, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,     TAR_IGNORE, POS_STANDING,
    &gsn_patch,     0, 0,
    "",             "!Patch!", "", FALSE, 2, SLOT(0)
  },

  {
    ...
    NULL,           14, 20,
    "flamesphere",  "!Flamesphere!", "", TRUE, 4, SLOT(58)
  },
...

  {
    ...
    "mental drain",		"!Mental Drain!",	"", FALSE, 3, SLOT(0)
  },

  {
    "drain life",
    { L_APP, L_APP, L_APP, L_APP, 5, L_APP, L_APP, L_APP, L_APP, 10,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    &gsn_drain_life,	0,	12,
    "&zlife &wdrain",		"!Drain Life!",	"", FALSE, 4, SLOT(0)
  },

  {
    ...
    "The divine strength surrounding $n fades.", FALSE, 3, SLOT(59)
  },

  {
    ...
    "$n feels in sync with nature once again.",TRUE, 3, SLOT(60)
  },

  {
    ...
    "$n's vision returns to normal.", TRUE, 1, SLOT(61)
  },

  {
    ...
    NULL,			5,	12,
    "",			"You feel less protected.",	
    "$n looks less protected.", TRUE, 2, SLOT(62)
  },
...

  {
    ...
    "The peace within $n disappears.", FALSE, 3, SLOT(0)
  },

  {
    ...
    spell_null,		TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    &gsn_turn_evil,		0,	12,
    "&Wdivine power&X",		"!Turn Evil!",	"", FALSE, 3, SLOT(0)
  },
...

  {
    ...
    NULL,			50,	12,
    "&Who&Rly fl&rames&X",		"!Holy Fires!", "", FALSE, 2, SLOT(0)
  },

  {
    "true sight",
    {    51, L_APP,   L_APP, L_APP, 36, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_truesight,	TAR_CHAR_SELF,		POS_STANDING,
    NULL,			59,	12,
    "",			"Your vision is no longer so true.", 
    "$n's vision returns to normal.", TRUE, 20, SLOT(64)
  },

  {
    ...
    "The phantom blades surrounding $n disappear.", TRUE, 10, SLOT(65)
  },
...

  {
    ...
    &gsn_berserk,     0, 0,
    "",        "You feel more sane.", 
    "$n has regained $s sanity.", FALSE, 5, SLOT(0)
  },

  {
    ...
    NULL,			25,	14,
    "",			"The webs melt away.", 
    "The webs entangling $n melt away.", TRUE, 4, SLOT(66)
  },

  {
    ...
    NULL,			25,	14,
    "",			"The force releases control of your legs.", 
    "$n can move his legs again.", TRUE, 6, SLOT(67)
  },

  {
    ...
    "The sweet caress of oblivion rises from $n.", TRUE, 10, SLOT(68)
  },
/* 250 */
  {
    "bio-acceleration", 
    ...
    "$n's body returns to a normal form.", FALSE, 10, SLOT(69)
  },

  {
    ...
    "$n looks less confused.", TRUE, 8, SLOT(70)
  },
...

  {
    ...
    "$n slows down.", TRUE, 8, SLOT(71)
  },

  {
    "trip",
    { L_APP, L_APP, 35, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,             TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    &gsn_trip,              0,      12,
    "trip",                "!Trip!", "", FALSE, 2, SLOT(0)
  },

  {
    ...
    spell_null,             TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    &gsn_dirt_kick,		0,      12,
    "dirt kick",		"!Dirt Kick!", "", FALSE, 3, SLOT(0)
  },

  {
    "chain lightning",
    { 42, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_chain_lightning,	TAR_IGNORE,		POS_FIGHTING,
    NULL,			50,	22,
    "&Belectrical blast&X",   	"!CHAIN LIGHTNING!", "", FALSE, 3, SLOT(0)
  },

  {
    ...
    NULL,			150,	25,
    "&rm&Oe&Yt&Oe&ro&Yr&rs",       	"!SWARM!", "", TRUE, 4, SLOT(72)
  },

  {
    ...
    NULL,			150,	25,
    "&wmental shockwave&X",   	"!PSY-QUAKE!", "", FALSE, 4, SLOT(0)
  },

  {
    ...
    "$n looks more confident.", TRUE, 4, SLOT(73)
  },

  {
    ...
    "Dancing lights about $n fade away.", FALSE, 3, SLOT(74)
  },

  {
    "shadow walk",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 4,
      L_APP,      L_APP,      L_APP },
    spell_null,             TAR_IGNORE,             POS_STANDING,
    &gsn_shadow_walk,       0,     22,
    "",                     "!SHADOW WALK!", "", FALSE, 8, SLOT(0)
  },

  {
    ...
    spell_null,		TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    &gsn_circle,		0,	 12,
    "sneak attack",		"!CIRCLE!", "", FALSE, 15, SLOT(0)
  },
...

  {
    ...
    "$n's body shifts back into the existing world.", FALSE, 30, SLOT(75)
  },

  {
    ...
    "$n looks more stable.", TRUE, 5, SLOT(76)
  },

  {
    ...
    spell_null,           TAR_CHAR_OFFENSIVE,     POS_FIGHTING,
    &gsn_soulstrike,      0,      24,
    "soul",        "!Soulstrike!",   "", FALSE, 4, SLOT(0)
  },
...

  {
    ...
    "Thalador's blessing rises from $n's soul.", FALSE, 1, SLOT(77)
  },
  {
    "spellcraft",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
  ...
  },
  {
    ...
    spell_null,		TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    &gsn_multiburst,	0, 24,
    "",		"!Multiburst!", "", FALSE, 20, SLOT(0)
  },
/* Necromancer spells by Hannibal. */
  {
    "hex",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 5,
      L_APP,      L_APP,      L_APP },
    spell_hex,		 TAR_CHAR_OFFENSIVE,	POS_FIGHTING,
    NULL,	 	75, 12,
    "", "The hex placed upon your soul wears off.", 
    "The hex placed upon $n's soul vanishes.", TRUE, 10, SLOT(78)
  },
  {
    "dark ritual",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
...
TRUE, 5, SLOT(79)
  },
  {
    ...
    NULL,			15, 12,
    "&zstench of decay&X", "!Stench of Decay!", "", FALSE, 5, SLOT(0)
  },
/* Werewolf starts here -- Hannibal */
  ...
  },
  {
    ...
    "$n calms down as the rage leaves $m.", FALSE, 5, SLOT(80)
  },
  {
    "bite",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 1,
    ...
    spell_null,			TAR_CHAR_OFFENSIVE, POS_FIGHTING,
    &gsn_bite,			0, 12,
    "vicious bite", "!Bite!", "", FALSE, 6, SLOT(0)
  }, 
  {
    "adrenaline rush",
    { L_APP, L_APP, L_APP, 5, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null,		TAR_IGNORE,	POS_RESTING,
    &gsn_rush,			0, 12,
    "",
    "You feel the rush of adrenaline wash away.", 
    "$n has calmed down.", FALSE, 4, SLOT(81)
  },

  {
    ...
    "$n doesn't look so terrified anymore.", FALSE, 1, SLOT(82)
  },
  ...
  },
  {
    ...
    &gsn_frenzy,     0, 0,
    "",        "You feel more sane.",
    "$n's sanity returns.", FALSE, 5, SLOT(82)
  },
  {
    "enhanced reflexes",
    ...
    spell_null,		TAR_CHAR_SELF,	POS_STANDING,
    &gsn_reflex,	0, 36,
    "", "Your reflexes slow down.", "$n slows down.", FALSE, 4, SLOT(84)
  },
  {
    "rake eyes",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
...
L_APP,
    ...
    NULL,                       75,     12,
    "",                 "The white aura around your body fades.", 
    "The white aura surrounding $n fades away.", TRUE, 1, SLOT(85)
  },
...
L_APP,
...

  {
    ...
    NULL,                       5,      12,
    "",                 "The red in your vision disappears.", 
    "$n's vision returns to normal.", TRUE, 1, SLOT(86)
  },
...
L_APP,
    ...
    NULL,                       15,     12,
    "&Cch&wil&Cli&wng &Cto&wu&Cch&X",
    "You feel less cold.", "$n looks less cold.", TRUE, 1, SLOT(87)
  },
...
L_APP,
    ...
    NULL,                       5,      18,
    "",                 "You no longer see in the dark.", 
    "$n's vision returns to normal.", TRUE, 1, SLOT(88)
  },
...
L_APP,
    ...
    NULL,                       5,      12,
    "",                 "You feel less protected.", 
    "$n looks less protected.", TRUE, 4, SLOT(89)
  },
...
L_APP, 
    ...
    spell_burning_hands,        TAR_CHAR_OFFENSIVE,     POS_FIGHTING,
    NULL,                       15,     12,
    "&rbu&Yrni&Wng &rh&Oa&Yn&Wds&X","!Burning Hands!", "", FALSE, 1, SLOT(0)
  },
...
L_APP,
    ...
    NULL,                       5,      12,
    "",                 "The detect magic wears off.", 
    "$n's vision returns to normal.", TRUE, 1, SLOT(90)
  },
...
L_APP,
    ...
    NULL,                       10,     18,
    "",                 "You slowly float to the ground.", 
    "$n slowly floats to the ground.", TRUE, 1, SLOT(91)
  },
...
L_APP,
    ...
    &gsn_charm_person,  5,      12,
    "",                 "You feel more self-confident.", 
    "$n looks more confident.", TRUE, 1, SLOT(92)
  },
...
L_APP,
    ...
    NULL,                       35,     20,
    "",                 "Your vision returns to normal.", 
    "$n's vision returns to normal.", TRUE, 1, SLOT(93)
  },
...
L_APP,
    ...
    NULL,                       20,     12,
    "",                 "You feel weaker.", 
    "$n looks much weaker.", TRUE, 1, SLOT(94)
  },
...
L_APP,
    ...
    NULL,                       5,      12,
    "",                 "You no longer see invisible objects.", 
    "$n's vision returns to normal.", TRUE, 1, SLOT(95)
  },
...
L_APP,
    ...
    spell_flamestrike,  TAR_CHAR_OFFENSIVE,     POS_FIGHTING,
    NULL,                       20,     12,
    "&rflame&Rstrike",		"!Flamestrike!", "", FALSE, 1, SLOT(0)
  },
...
L_APP,
    ...
    &gsn_invis,         5,      12,
    "",                 "You are no longer invisible.", 
    "$n appears from thin air.", TRUE, 1, SLOT(96)
  },
...
L_APP,
    ...
    NULL,                       12,     18,
    "",                 "Your force shield shimmers then fades away.", 
    "The force shield surrounding $n shimmers and fades away.", FALSE,
1, SLOT(98)
  },
...
L_APP,
    ...
    NULL,                           6,      12,
    "",                             "The adrenaline rush wears off.", 
    "$n doesn't seem so pumped up anymore.", FALSE, 1, SLOT(99)
  },
...
L_APP,
    ...
    spell_acid_blast,   TAR_CHAR_OFFENSIVE,     POS_FIGHTING,
    NULL,                       20,     12,
    "&gacid blast&X",		"!Acid Blast!", "", FALSE, 1, SLOT(0)
  },
...
L_APP,
    ...
    NULL,                       5,      12,
    "",                 "You feel less aware of your suroundings.", 
    "$n's vision returns to normal.", TRUE, 1, SLOT(100)
  },
...
L_APP,
    ...
    "The curse within $n vanishes.", TRUE, 1, SLOT(101)
  },
...
L_APP,
    ...
    spell_earthquake,           TAR_IGNORE,             POS_FIGHTING,
    NULL,                       15,     12,
    "&Oearthquake&X",		"!Earthquake!", "", FALSE, 1, SLOT(0)
  },
...
L_APP,
    ...
    "The pink aura enveloping $n slowly fades away.", TRUE, 1, SLOT(102)
  },
...
L_APP,
    ...
    NULL,                       20,     12,
    "",                  "You feel solid again.", 
    "$n's body appears more solid.", TRUE, 1, SLOT(103)
  },

  {
   ...
   spell_faerie_fog,            TAR_IGNORE,           POS_STANDING,
   NULL,                        12,     12,
   "faerie fog",         "!Faerie Fog!", "", FALSE, 1, SLOT(0)
  },

  {
   ...
   NULL,                        12,     18,
   "",                   "Your skin feels soft again.", 
   "$n's skin takes on a softer texture.", TRUE,  1, SLOT(104)
  },

  {
   ...
   &gsn_sleep,                  15,     12,
   "",                   "You feel less tired.",        
   "$n looks more energetic.", TRUE,  1, SLOT(105)
  },

  {
   ...
   { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
    ...
    spell_fireball,             TAR_CHAR_OFFENSIVE,   POS_FIGHTING,
    NULL,                       15,     12,
    "&Rfireball&X",		"!Fireball!", "", FALSE, 1, SLOT(0)
  },
...
1, SLOT(0)
...

  {
   ...
   NULL,                        59,     12,  
   "",                  "Your vision is no longer so true.", 
   "$n's vision returns to normal.", TRUE, 1, SLOT(106)
  },

  {
   ...
   "The flames surrounding $n suddenly burn out.", TRUE, 1, SLOT(107)
  },
...
1, SLOT(0)
...

  {
    ...
    "The &rflames &won $n's hands flicker and vanish.", FALSE, 3, 
SLOT(108)
  },
  {
    "frosthand",
    ...
    "The &Cfrost&w and &Cice&w melt from $n's hands.", FALSE, 3, SLOT(109)
  },
  {
    "chaoshand",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
  ...
  },
  {
    ...
    spell_null,		TAR_IGNORE,		POS_FIGHTING,
    &gsn_bladepalm,	0,	18,
    "blade palm",	"!Blade Palm!",		"", FALSE, 6, SLOT(0)
  },
  {
    "flying kick",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
    ...
    spell_null,		TAR_IGNORE,		POS_FIGHTING,
    &gsn_flykick,	0,	12,
    "flying kick",	"!Flying Kick!", "", FALSE, 3, SLOT(0)
  },
  {
    "anatomy knowledge",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
...
2, SLOT(0)
  ...
  },
  {
    ...
    "Feeling returns to $n's arms.", FALSE, 6, SLOT(111)
  },
  {
    "soulbind",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
  ...
  },
  {
    ...
    "",
    "Your skin returns to normal.",
    "$n's skin returns to its normal texture.", TRUE, 3, SLOT(112)
  },
  {
    "chi shield",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
    ...
    "The chi shield surrounding $n dissipates.", FALSE, 3, SLOT(113)
  },
  {
    "ironfist",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
    ...
    "$n's fists return to a normal structure.", FALSE, 3, SLOT(114)
  },
  {
    "Globe of Darkness",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
    ...
    "The globe of darkness about $n dissipates.", TRUE, 1, SLOT(0)
  },
  {
    "drow fire",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
...

  {
    ...
    "",			"!Enhanced Damage Two!", "", FALSE, 7, SLOT(0)
  },
...

 {
    ...
    "",                 
    "You feel solid again.",
    "$n's body becomes more solid.", TRUE, 4, SLOT(115)
  },
{
    "mist form",
  ...
  },
  {
    ...
    "The golden aura around $n's body vanishes.", TRUE, 25, SLOT(117)
  },
  {
    "shriek",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
L_APP,
  ...
  },
  {
    ...
    "The acidic spit burning $n evaporates.", FALSE, 1, SLOT(118)
  },
  {
    "ward of safety", 
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
    ...
    "The wards of safety crumble.", FALSE, 4, SLOT(0)
  },
  {
    "ward of healing", 
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
    ...
    "The wards of healing crumble.", FALSE, 4, SLOT(0)
  },
...
L_APP,
    ...
    NULL,			15,	12,
    "thunder strike",		"!thunder strike!", "", 5, SLOT(0)
  },
...
L_APP,
    ...
    "The inspiration within $n disappears.", FALSE, 3, SLOT(0)
  },
...
L_APP,
     ...
     NULL,			15,	12,
     "war cry",			"!War cry!", "", 4, SLOT(0)
  },  

  {
    "group healing",
    { L_APP, 4, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
     spell_group_healing,       TAR_CHAR_DEFENSIVE,     POS_FIGHTING,
     NULL,                       50,     12,
     "",                 "!Group Heal!", "", FALSE, 6, SLOT(0)  
  },
...
L_APP,
...

  {
    ...
    "$n's blurred form focuses suddenly.", FALSE, 3, SLOT(201)
  },

  {
    ...
    NULL,			55,	22,
    "&Rroaring flames&X",   	"!FIRWALL!", "", FALSE, 4, SLOT(0)
  },

  {
    ...
    "$n's body doesn't look so weak anymore.", FALSE, 4, SLOT(202)
  },

{
    ...
    spell_null,           TAR_IGNORE,   POS_STANDING,
    &gsn_scrolls,    0, 0,
    "&Wfailure",    "!Scrolls!", "", FALSE, 3, SLOT(0)
  },
...

{
    ...
    spell_null,           TAR_IGNORE,   POS_STANDING,
    &gsn_staves,    0, 0,
    "&Wfailure",    "!Staves!", "", FALSE, 3, SLOT(0)
  },
  {
    "Archery",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
...

  {
    ...
    "$N is somatic once again.", TRUE, 5, SLOT(0)
   },

   {
    ...
    { L_APP, L_APP, L_APP, L_APP, L_APP, 10, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
     spell_null, TAR_CHAR_OFFENSIVE, POS_FIGHTING,
     &gsn_lure, 0,   32, "", "!lure!", FALSE, 15, SLOT(0)
    },
   {
    "flip",
    { L_APP, L_APP, 4, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
      spell_null, TAR_CHAR_OFFENSIVE, POS_FIGHTING,
      &gsn_flip, 0,  32, "flip", "!flip!", FALSE, 8, SLOT(0)
    },
   {
    "counter",
    { L_APP, L_APP, L_APP, L_APP, L_APP, 10, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
      spell_null, TAR_IGNORE, POS_FIGHTING,
      &gsn_counter, 0, 32, "counter attack", "!counter!", FALSE, 12, 
SLOT(0)
    },
    {
    "image",
    { 101, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 101,
      L_APP,      L_APP,      L_APP },
	spell_image, TAR_CHAR_DEFENSIVE, POS_STANDING,
	&gsn_image, 50, 12, "",
	"Your images fade.",
	"$n's multiple images fade.", TRUE, 15, SLOT(0)
    },
    {
     "unholy strength",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 101,
      L_APP,      L_APP,      L_APP },
	spell_unholystrength, TAR_CHAR_DEFENSIVE, POS_STANDING,
	&gsn_unholystrength, 25, 12, "",
	"You feel the strength of darkness leave you.",
	"$n seems weaker.", TRUE, 6, SLOT(0)
    },
    {
    "doomshield",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
	spell_doomshield, TAR_CHAR_DEFENSIVE, POS_STANDING,
	&gsn_doomshield, 40, 12, "",
	"You feel less entropic.",
	"Brooding evil leaves $n.", TRUE, 5, SLOT(0)
    },
    {
    "transmute",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP},
	spell_null, TAR_IGNORE, POS_STANDING,
	&gsn_transmute, 70, 12, "", "!transmute!",FALSE, 10, SLOT(0)
    },
    {
    "purify",
    { 101, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	...
	NULL, 70, 12, "", "!purify!", FALSE, 5, SLOT(0)
    },

    { "awareness",
        {  L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, 
      L_APP,    L_APP,      L_APP },
      spell_awareness, TAR_CHAR_SELF, POS_STANDING,
      &gsn_awareness, 15, 12, "", "", "Your vision returns to normal",
      FALSE, 3, SLOT(0)
    },
...
L_APP, 
     L_APP,     L_APP,      L_APP },
     spell_null, TAR_CHAR_OFFENSIVE, POS_FIGHTING,
     &gsn_dragonpunch, 0, 12, "dragonpunch", "!dragonpunch!",FALSE, 20, SLOT(0)
     },

    { "tornado",
	{ L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
	  L_APP, L_APP, L_APP,
        L_APP,      L_APP,      L_APP },
	spell_null, TAR_IGNORE, POS_STANDING,
	&gsn_tornado, 0, 12, "tornado", "!tornado!",FALSE, 7, SLOT(0)
    },
    ...
    { "flare",
        ...
        L_APP,      L_APP,      L_APP },
        spell_null, TAR_IGNORE, POS_STANDING,
	&gsn_flare, 0, 12, "flare", "!flare!",FALSE, 8, SLOT(0)
    },
  {
    "remove blessing",
    { 3, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_remove_blessing, TAR_CHAR_OFFENSIVE,     POS_FIGHTING,
    NULL,                       100,     16,
    "",                 "!Remove Blessing!", "", FALSE, 8, SLOT(0)
  },
  {
    "bullet shot",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null, TAR_CHAR_OFFENSIVE, POS_FIGHTING,
    &gsn_bullet_shot, 100, 16,
    "shot", "!bullet shot!", FALSE, 0, SLOT(0)
  },
  {
    "energy shot",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP,      L_APP,      L_APP },
    spell_null, TAR_CHAR_OFFENSIVE, POS_FIGHTING,
    &gsn_energy_shot, 100, 16,
    "energy blast", "!energy shot!", FALSE, 0, SLOT(0)
  },
  {
    "creation",
    { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
  ...
  },
  {
    ...
    spell_null,           TAR_IGNORE,   POS_STANDING,
    &gsn_disarming,    0, 0,
    "",    "!DISARM!", "", FALSE, 5, SLOT(0)
  },
	{
		"loadplayer",
		{ 1, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
      L_APP, L_APP, L_APP },
	  spell_null, TAR_IGNORE,	POS_STANDING,
	  &gsn_loadplayer, 0, 0,
	  "", "!LOADPLAYER!", "", FALSE, 8, SLOT(0)
	},
	{
		"dial",
		{ 1, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
...
/*
    { "sandstorm",
        ...
        L_APP,      L_APP,      L_APP },
        spell_null, TAR_IGNORE, POS_STANDING,
        &gsn_sandstorm, 0, 12, "sandstorm", "!sandstorm!", 5, SLOT(0)
    },
*/
/*
    { "flash flood",
        { L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
          L_APP, L_APP, L_APP, L_APP, L_APP, L_APP, L_APP,
          L_APP, L_APP, L_APP, 95,
        L_APP,      L_APP,      L_APP },
        spell_null, TAR_IGNORE, POS_STANDING,
        &gsn_flash_flood, 0, 12, "flash_flood", "!flash_flood!", 5, SLOT(0)
    },
*/
/*
...
/*{wait,SLOT(slot),{MAG,CLE,THI,WAR,PSI,DRU,RAN,PAL,BAR,VAM,
  ...
  { 2, SLOT(227), {2,1,0,0,2,1,0,0,0,0} },
};
/*
const struct  stance_type stance_table [2] =
{
