...
/* FUN STUFF */
 {"armbomb",	do_armbomb,	POS_STANDING,	0, LOG_NORMAL },
	{ "simulate",	do_simulate, POS_STANDING, 0, LOG_NORMAL },
...
//    { "sing",		do_cast,	POS_FIGHTING,	 0,  LOG_NORMAL },
   ...
   /* { "skin",           do_skin,        POS_STANDING,    0,LOG_NORMAL}, */
    { "stand",		do_stand,	POS_SLEEPING,	 0,  LOG_NORMAL	},
    { "tell",		do_tell,	POS_RESTING,	 0,  LOG_NORMAL	},
    { "pray",           do_wish,        POS_RESTING,     0,  LOG_NORMAL },
    { "track",          do_track,       POS_STANDING,    0,  LOG_NORMAL },
    { "third",		do_third,	POS_RESTING,	 30, LOG_NORMAL },
    { "war",	do_war, POS_RESTING, 0, LOG_NORMAL },
...
/*    { "affected",       do_affectedby,  POS_DEAD,        0,  LOG_NORMAL },  */
 ...
 {"exitmech", do_exitmech, POS_STANDING, 0, LOG_NORMAL },
    ...
    { "unmount",	do_unmount,	POS_STANDING,	0, LOG_NORMAL },
    { "combination",	do_combination,	POS_STANDING,	0, LOG_NORMAL },
    { "creation",	do_creation, 	POS_STANDING,	0, LOG_NORMAL },
    { "duplicate",	do_duplicate,	POS_STANDING,	0, LOG_NORMAL },
...
*/
 ...
 /*   { "farsight",      do_farsight,     POS_STANDING,   30,  LOG_NORMAL }, */
    ...
    { "nofollow",	do_nofollow,	POS_DEAD,	0, LOG_NORMAL },
    { "description",	do_description,	POS_DEAD,	 0,  LOG_NORMAL	},
 { "mdesc", do_mdesc, POS_DEAD, 0, LOG_NORMAL },
...
/*    { "plan",		do_plan,	POS_DEAD,	 0,  LOG_NORMAL },   */
    ...
    { "learn",		do_learn,	POS_DEAD,	0, LOG_NORMAL },
...
//    { "answer",		do_answer,	POS_SLEEPING,	 0,  LOG_NORMAL },
    ...
    { "transmute",	do_transmute, POS_STANDING, 0, LOG_NORMAL },
    /*
     * Combat commands.
     */
    ...
    { "addbionic",	do_addbionic,   POS_STANDING,	0, LOG_NORMAL	},
    { "rembionic",	do_rembionic,   POS_STANDING,   0, LOG_NORMAL   },
    ...
    { "engage",         do_engage,      POS_STANDING,    0,  LOG_NORMAL },
    ...
    { "dragonpunch",    do_dragonpunch, POS_FIGHTING,     0, LOG_NORMAL },
    { "tornado",        do_tornado, POS_STANDING,         0, LOG_NORMAL },
    { "flare",		do_flare,	POS_FIGHTING,    0,  LOG_NORMAL },
/*  { "sandstorm,"      do_sandstorm,	POS_FIGHTING,	 0,  LOG_NORMAL },
*/
...
//    { "multiburst",	do_multiburst,	POS_FIGHTING,	 0,  LOG_NORMAL },
    ...
    { "siege", do_siege, POS_STANDING, 0, LOG_NORMAL },
    { "call", do_call, POS_STANDING, 0, LOG_NORMAL },
    { "hangup", do_hangup, POS_STANDING, 0, LOG_NORMAL },
    { "chameleon power",do_chameleon,   POS_STANDING,    0,  LOG_NORMAL },
    { "dial",		do_dial,   POS_STANDING,    0,  LOG_NORMAL },
	...
	{ "loadplayer", do_loadplayer,  POS_STANDING,	0, LOG_NORMAL },
    { "poison weapon",	do_poison_weapon,POS_SLEEPING,	 0,  LOG_NORMAL	},
    { "practice",	do_practice,	POS_SLEEPING,	 0,  LOG_NORMAL	},
    { "rebirt",		do_rebirt,	POS_RESTING,	0, LOG_NORMAL },
    { "rebirth",	do_rebirth,	POS_RESTING, 0, LOG_NORMAL }, 
    ...
    { "pray",           do_pray,        POS_RESTING,    107,  LOG_NORMAL },
...
/*    { "load",           do_load,        POS_DEAD,  L_DIR,  LOG_NORMAL }, */
    ...
    { "astat",          do_astat,       POS_DEAD,  L_SEN,  LOG_NORMAL },
    { "astrip",         do_astrip,      POS_DEAD,  L_DIR,  LOG_NORMAL },
    ...
    { "banlist",	      do_banlist,     POS_DEAD,  L_DIR,  LOG_NORMAL },
    ...
    { "cloak",          do_cloak,       POS_DEAD,  L_JUN,  LOG_NORMAL },
    { "clone",		do_clone,       POS_DEAD,  L_DIR,  LOG_NORMAL },
    { "countcommands",  do_countcommands,POS_DEAD, L_APP,  LOG_NORMAL },
    { "cset",           do_cset,        POS_DEAD,  L_DIR,  LOG_BUILD  },
    { "deny",           do_deny,        POS_DEAD,  L_IMP,  LOG_ALWAYS },
    { "undeny",         do_undeny,      POS_DEAD,  L_IMP,  LOG_ALWAYS },
    ...
    { "disconnect",     do_disconnect,  POS_DEAD,  L_DIR,  LOG_ALWAYS },
    { "echo",           do_echo,        POS_DEAD,  L_DIR,  LOG_ALWAYS },
	...
	{ "godim",          do_godim,       POS_DEAD,  L_APP,  LOG_NORMAL },
    { "hero",           do_hero,        POS_DEAD,    LEVEL_HERO,    LOG_NORMAL },
    ...
    { "impify",         do_impify,      POS_DEAD,  0,      LOG_NEVER  },
    { "shieldify",      do_shieldify,   POS_STANDING,  L_CON, LOG_NORMAL },
    { "readlog",        do_showlog,     POS_DEAD,  L_CON,  LOG_NORMAL },
    { "doubleexp",      do_doubleexp,   POS_DEAD,  L_DIR,  LOG_NORMAL },
    { "log",            do_log,         POS_DEAD,  L_CON,  LOG_ALWAYS },
    { "memory",         do_memory,      POS_DEAD,  L_CON,  LOG_NORMAL },
    { "mfind",          do_mfind,       POS_DEAD,  L_JUN,  LOG_NORMAL },
    { "mload",          do_mload,       POS_DEAD,  L_JUN,  LOG_BUILD  },
    { "mpstat",         do_mpstat,      POS_DEAD,  L_APP,  LOG_NORMAL },
    { "mpcommands",     do_mpcommands,  POS_DEAD,  L_JUN,  LOG_NORMAL },
    { "mset",           do_mset,        POS_DEAD,  L_DIR,  LOG_BUILD  },
    { "mstat",          do_mstat,       POS_DEAD,  L_DIR,  LOG_NORMAL },
    { "mwhere",         do_mwhere,      POS_DEAD,  L_JUN,  LOG_NORMAL },
    { "newban",		do_newban,      POS_DEAD,  L_DIR,  LOG_ALWAYS },
    { "newcorpse",	do_newcorpse,   POS_DEAD,  L_DIR,  LOG_ALWAYS },
    { "newlock",        do_newlock,     POS_DEAD,  L_IMP,  LOG_ALWAYS },
    { "noemote",        do_noemote,     POS_DEAD,  L_DIR,  LOG_NORMAL },
    { "notell",         do_notell,      POS_DEAD,  L_DIR,  LOG_NORMAL },
    { "notransfer",     do_notransfer,  POS_DEAD,  L_APP,  LOG_NORMAL },
    ...
    { "oset",           do_oset,        POS_DEAD,  L_CON,  LOG_BUILD  },
    ...
    { "qecho",          do_qecho,       POS_DEAD,  L_SEN,  LOG_ALWAYS },
    { "qset",           do_qset,        POS_DEAD,  L_SEN,  LOG_ALWAYS },
    { "racelist", 	    do_racelist,    POS_DEAD,  L_APP,  LOG_NORMAL },
    { "rebuild",        do_rebuild,	    POS_DEAD,  L_CON,  LOG_ALWAYS },
    { "reboo",          do_reboo,       POS_DEAD,  L_CON,  LOG_NORMAL },
    { "reboot",         do_reboot,      POS_DEAD,  L_CON,  LOG_ALWAYS },
    { "recho",          do_recho,       POS_DEAD,  L_SEN,  LOG_ALWAYS },
    { "restore",        do_restore,     POS_DEAD,  L_APP,  LOG_ALWAYS },
    ...
    { "silence",        do_silence,     POS_DEAD,  L_DIR,  LOG_NORMAL },
    { "sla",            do_sla,         POS_DEAD,  L_DIR,  LOG_NORMAL },
    { "slay",           do_slay,        POS_DEAD,  L_DIR,  LOG_ALWAYS },
    { "slaymes",        do_slaymes,     POS_DEAD,  L_DIR,  LOG_NORMAL },
    { "slookup",        do_slookup,     POS_DEAD,  L_DIR,  LOG_NORMAL },
    { "snoop",          do_snoop,       POS_DEAD,  L_DIR,  LOG_ALWAYS },
    { "sset",           do_sset,        POS_DEAD,  L_CON,  LOG_ALWAYS },
    ...
    { "transmes",       do_trmes,       POS_DEAD,  L_APP,  LOG_NORMAL },
    ...
    { "whotype",	      do_whotype,	    POS_DEAD,  L_APP,  LOG_NORMAL },
    ...
    { "wiznet",		do_wiznet,      POS_DEAD,  L_APP,  LOG_NORMAL },
...
/*
    { "counter",	do_counter,	POS_FIGHTING,    0,  LOG_NORMAL },
*/
...
/*    { "immlist",	do_immlist,	POS_DEAD, 	 0,  LOG_NORMAL },*/
     ...
     * OLC 1.1b
     */
    { "aedit",		do_aedit,	POS_DEAD, L_SEN,  LOG_BUILD  },
    { "cedit",          do_cedit,   POS_DEAD, L_CON,  LOG_BUILD  },
    { "hedit",          do_hedit,   POS_DEAD, L_JUN,  LOG_BUILD  },
    { "redit",		do_redit,	POS_DEAD, L_JUN,  LOG_BUILD  },
    { "oedit",		do_oedit,	POS_DEAD, L_JUN,  LOG_BUILD  },
    { "medit",		do_medit,	POS_DEAD, L_JUN,  LOG_BUILD  },
    { "asave",          do_asave,	POS_DEAD, L_JUN,  LOG_NORMAL },
    { "alist",		do_alist,	POS_DEAD, L_JUN,  LOG_NORMAL },
    { "resets",		do_resets,	POS_DEAD, L_JUN,  LOG_NORMAL },
    { "mreset",		do_mreset,	POS_DEAD, L_JUN,  LOG_NORMAL },

    { "sedit",		do_sedit,	POS_DEAD, L_DIR,  LOG_BUILD  },
    ...
    { "cube",		do_cube,	POS_DEAD, L_CON, LOG_BUILD },
    /*
     * End of list.
     */
...
*/    
  ...
  /*  {
	...
	"$n flexes $s muscles at $mself.  How narcisistic!"
    },
...
void interpret( CHAR_DATA *ch, char *argument )
{
 ...
 /*If you are sneaking you can move these directions while hiding*/
    ...
    if ( ch->in_vehicle != NULL && trust < LEVEL_IMMORTAL)
    {
      if ( (str_cmp( cmd_table[cmd].name, "push" ) &&
		    str_cmp( cmd_table[cmd].name, "look" ) &&
			...
			str_cmp( cmd_table[cmd].name, "mount") &&
			str_cmp( cmd_table[cmd].name, "engage") &&
			str_cmp( cmd_table[cmd].name, "shoot") &&
			str_cmp( cmd_table[cmd].name, "sneak"    ) &&
			str_cmp( cmd_table[cmd].name, "worth"    ) &&
			str_cmp( cmd_table[cmd].name, "affected" ) &&
			str_cmp( cmd_table[cmd].name, "open" ) &&
			str_cmp( cmd_table[cmd].name, "slist" ) &&
			str_cmp( cmd_table[cmd].name, "class" ) &&
			str_cmp( cmd_table[cmd].name, "scan" ) &&
			str_cmp( cmd_table[cmd].name, "say" ) &&
			str_cmp( cmd_table[cmd].name, "'" ) &&
			str_cmp( cmd_table[cmd].name, "ooc" ) &&
			str_cmp( cmd_table[cmd].name, "chat" ) &&
			str_cmp( cmd_table[cmd].name, "vent" ) &&
			str_cmp( cmd_table[cmd].name, "clans" ) &&
			str_cmp( cmd_table[cmd].name, "clan" ) &&
			str_cmp( cmd_table[cmd].name, "cinfo" ) &&
			str_cmp( cmd_table[cmd].name, "lock" ) &&
		      str_cmp( cmd_table[cmd].name, "score")) )
      {
	send_to_char( AT_BLOOD, "You cannot do that while in a vehicle.\n\r",ch);
	return;
      }
    }
