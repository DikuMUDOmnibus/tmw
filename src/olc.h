...
void	kedit		args( ( CHAR_DATA *ch, char *argument ) );
...
/* keditor functions */
DECLARE_OLC_FUN( kedit_show             );
DECLARE_OLC_FUN( kedit_create		);
DECLARE_OLC_FUN( kedit_name             );
DECLARE_OLC_FUN( kedit_recall		);
DECLARE_OLC_FUN( kedit_members          );
DECLARE_OLC_FUN( kedit_pkilled		);
DECLARE_OLC_FUN( kedit_pdeaths          );
DECLARE_OLC_FUN( kedit_desc		);
DECLARE_OLC_FUN( kedit_general          );
DECLARE_OLC_FUN( kedit_bitvector	);
...
DECLARE_OLC_FUN( oedit_dimension		);
...
DECLARE_OLC_FUN( medit_dimension		);
