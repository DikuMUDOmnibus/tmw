...
void wear_bionic( CHAR_DATA *ch, OBJ_DATA *obj, bool fReplace )
{
	...
	if ( !get_bionic_char( ch, BIONIC_EYE_L ) )
	{
	    act(AT_BLUE, "A $p is implanted in your left eye socket.",  ch, obj, NULL, TO_CHAR );
	    act(AT_BLUE, "$n gets $p implanted in $s left eye socket.",    ch, obj, NULL, TO_ROOM );
	...
	{
	    act(AT_BLUE, "A $p is implanted in your right eye socket.", ch, obj, NULL, TO_CHAR );
	    act(AT_BLUE, "$n gets $p implanted in $s right eye socket.",   ch, obj, NULL, TO_ROOM );
	    equip_bionic( ch, obj, BIONIC_EYE_R );
	    return;
	}
	...
	{
	    act(AT_BLUE, "A $p is implanted in your left arm socket.",  ch, obj, NULL, TO_CHAR );
	    act(AT_BLUE, "$n gets $p implanted in $s left arm socket.",    ch, obj, NULL, TO_ROOM );
	...
	{
	    act(AT_BLUE, "A $p is implanted in your right arm socket.", ch, obj, NULL, TO_CHAR );
	    act(AT_BLUE, "$n gets $p implanted in $s right arm socket.",   ch, obj, NULL, TO_ROOM );
	    equip_bionic( ch, obj, BIONIC_ARM_R );
	    return;
	}
	...
	{
	    act(AT_BLUE, "A $p is implanted in your left hand socket.",  ch, obj, NULL, TO_CHAR );
	    act(AT_BLUE, "$n gets $p implanted in $s left hand socket.",    ch, obj, NULL, TO_ROOM );
	...
	{
	    act(AT_BLUE, "A $p is implanted in your right hand socket.", ch, obj, NULL, TO_CHAR );
	    act(AT_BLUE, "$n gets $p implanted in $s right hand socket.",   ch, obj, NULL, TO_ROOM );
	    equip_bionic( ch, obj, BIONIC_HAND_R );
	    return;
	}
	...
	{
	    act(AT_BLUE, "A $p is implanted in your left leg socket.",  ch, obj, NULL, TO_CHAR );
	    act(AT_BLUE, "$n gets $p implanted in $s left leg socket.",    ch, obj, NULL, TO_ROOM );
	...
	{
	    act(AT_BLUE, "A $p is implanted in your right leg socket.", ch, obj, NULL, TO_CHAR );
	    act(AT_BLUE, "$n gets $p implanted in $s right leg socket.",   ch, obj, NULL, TO_ROOM );
	    equip_bionic( ch, obj, BIONIC_LEG_R );
	    return;
	}
...
void equip_bionic( CHAR_DATA *ch, OBJ_DATA *obj, int iWear )
{
    ...
    SET_BIT( obj->extra_flags, ITEM_BIONIC_EQPD );
...
void unequip_bionic( CHAR_DATA *ch, OBJ_DATA *obj )
{
    ...
    ch->armor		+= apply_ac( obj, obj->bionic_loc );
    obj->bionic_loc	 = -1;
	REMOVE_BIT( obj->extra_flags, ITEM_BIONIC_EQPD );
