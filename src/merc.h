...
typedef struct  dimension_data  DIMENSION_DATA;
...
#define LEVEL_HERO		  200

#define LEVEL_IMMORTAL		  206
#define LEVEL_MORTAL 		  205
...
struct mech_data
{
    CHAR_DATA *mch;   /* person(s) in the mech */
    CHAR_DATA *mvict; /* person(s) affected by mech */
    bool fire_gas;
    bool fire_guns;
    bool fire_napalm;
    bool fire_missile;
...
struct	class_type
{
    ...
    short	prereq[ MAX_CLASS ];    /* Class prerequisites */
};
#if 0
struct  race_type
{
...
#define BV32	0x00000007
#define BV33	0x00000070
#define BV34	0x00000700
...
#define ACT_NODAMAGE		BV24
#define ACT_MUTATION		BV25
/*
...
#define AFF_DOOMSHIELD  BV01
#define AFF_UNHOLYSTRENGTH BV02
#define AFF_IMAGE	BV03
 ...
 * Defined in #OBJECTS.
 */
#define OBJ_VNUM_BULLET_SHELL		72
...
#define ITEM_RANGED_WEAPON		32
#define ITEM_SIEGE			33
#define ITEM_CLIP			34
#define ITEM_BULLET			35
#define ITEM_BOMB			36
#define ITEM_MECH			37
#define ITEM_PARMOR			38
#define ITEM_VEHICLE		39
#define ITEM_PHONE			40
//#define ITEM_POTION_BAG		     32

#define BOMB_EXPLOSIVE  0
#define BOMB_NAPALM     1
#define BOMB_CHEMICAL   2
...
#define ITEM_AMMUNITION            65536
#define ITEM_BURST                131072
#define ITEM_AUTOMATIC            262144
#define ITEM_LOADED               524288		/*	20	*/
#define ITEM_BIONIC_EQPD         1048576
#define ITEM_RINGING	         2097152
...
#define ITEM_ANTI_NINJA		     8192
#define ITEM_ANTI_AIRKIN            16384
#define ITEM_ANTI_EARTHKIN          32768
#define ITEM_ANTI_FIREKIN           65536
#define ITEM_ANTI_WATERKIN	   131072
...
#define ITEM_ANTI_KREEN             65536
#define ITEM_ANTI_ELEMENTAL        131072
/*
 * Wear flags.
 * Used in #OBJECTS.
 */
...
#define ITEM_DOUBLE_FINGER      2097152
#define ITEM_DOUBLE_NECK        4194304
#define ITEM_DOUBLE_WRIST       8388608
#define ITEM_DOUBLE_EAR        16777216
#define ITEM_DOUBLE_ANKLE      33554432
...
#define RED_WAIT_ROOM	 3042
#define BLUE_WAIT_ROOM   3043
#define GREEN_WAIT_ROOM  3044
#define YELLOW_WAIT_ROOM 3045
#define TEAM_RED_START		3000
#define TEAM_BLUE_START		3039
#define TEAM_GREEN_START	3020
#define TEAM_YELLOW_START	3041
...
#define ROOM_VNUM_SMITHY	25123
#define ROOM_ARENA_VNUM		25201
#define ROOM_ARENA_ENTER_F	25203
#define ROOM_ARENA_ENTER_S	25207
...
#define EX_ISWALL		    512
#define EX_ISWINDOW	        1024
...
#define WEAR_FINGER_R		      8
#define WEAR_NECK_1		      16
#define WEAR_NECK_2		      32
#define WEAR_BODY		      64
#define WEAR_HEAD		      128
#define WEAR_IN_EYES		      256
#define WEAR_ON_FACE		      512
#define WEAR_ORBIT                    1024
#define WEAR_ORBIT_2                 2048
#define WEAR_LEGS		     4096
#define WEAR_FEET		     8192
#define WEAR_HANDS		     16384
#define WEAR_ARMS		     32768
#define WEAR_SHIELD		     65536
#define WEAR_ABOUT		     131072
#define WEAR_WAIST		     262144
#define WEAR_WRIST_L		     524288
#define WEAR_WRIST_R		     1048576
#define WEAR_WIELD		     2097152
#define WEAR_WIELD_2		     4194304
#define WEAR_HOLD		     8388608
#define WEAR_EAR_R                   16777216
#define WEAR_EAR_L		     33554432
#define WEAR_ANKLE_L                 67108864
#define WEAR_ANKLE_R                 134217728
#define WEAR_WIELD_3		     268435456
...
#define PLR_AUTOASSIST		BV01
#define PLR_NOFOLLOW		BV02
#define PLR_NOSUMMON		BV03
#define PLR_REMORT		BV04
#define PLR_NOTRANSFER  BV05
/* War shit - Kjodo  */
#define PLR_WAR			BV06
#define TEAM_RED		BV07
#define TEAM_BLUE		BV08
/* new player bits here */
...
/*    int                 max_bp;*/
    ...
    int			raisepts;
    int			rangedir;
    int			class_level[ MAX_CLASS ];
	int         dimension;
	ROOM_INDEX_DATA *simulator;
	OBJ_DATA	*in_vehicle;
};
...
/* i doubt this stuff will even work */
extern int	gsn_archery;
extern int	gsn_farsight;
extern int	gsn_lure;
extern int	gsn_flip;
extern int	gsn_counter;
extern int	gsn_transmute;
extern int	gsn_doomshield;
extern int	gsn_image;
extern int	gsn_unholystrength;
extern int	gsn_dragonpunch;
extern int	gsn_tornado;
extern int 	gsn_flare;
extern int	gsn_bullet_shot;
extern int	gsn_energy_shot;
extern int	gsn_creation;
extern int	gsn_duplicate;
extern int	gsn_combine;
extern int  gsn_loadplayer;
extern int  gsn_dial;
/*
 * Utility macros.
 */
...
extern		WAR_DATA		war;
extern		DIMENSION_DATA	dimension;
 ...
 */
DECLARE_DO_FUN( do_simulate );
DECLARE_DO_FUN( do_armbomb	);
DECLARE_DO_FUN( do_doubleexp );
DECLARE_DO_FUN( do_impify );
DECLARE_DO_FUN( do_shieldify );
DECLARE_DO_FUN( do_showlog );
...
/* Ban Functions -- Hannibal -- Kjodo -- Torann */
...
DECLARE_DO_FUN( do_creation	);
DECLARE_DO_FUN( do_duplicate	);
DECLARE_DO_FUN( do_combine	);
DECLARE_DO_FUN( do_cube		);
DECLARE_DO_FUN( do_loadplayer );
DECLARE_DO_FUN( do_dial );
DECLARE_DO_FUN( do_answer );
...
DECLARE_SPELL_FUN(	spell_doomshield	);
DECLARE_SPELL_FUN(	spell_purify		);
DECLARE_SPELL_FUN(      spell_remove_blessing   );
/*
...
#define ARENA_DIR       "../arena/"     
#define AREA_DIR "../area/"
#define DATA_DIR "../data/"
#define LOG_DIR "../log/"
#define HELP_DIR "../help/"
#define MOB_DIR		AREA_DIR "MOBProgs/"  	/* MOBProg files*/
#define MOBPROG_FILE(x)	MOB_DIR #x
#endif


#define AREA_LIST	AREA_DIR "area.lst"	/* List of areas		*/
#define BUG_FILE	LOG_DIR "bugs.txt"      /* For 'bug' and bug( )		*/
#define IDEA_FILE	LOG_DIR "ideas.txt"	/* For 'idea'			*/
#define TYPO_FILE	LOG_DIR "typos.txt"     /* For 'typo'			*/
#define TODO_FILE	LOG_DIR "todo.txt"     /* For 'todo'			*/
#define CHANGES_FILE	LOG_DIR "changes.txt"     /* For 'changes'			*/
#define BAN_LIST	DATA_DIR "banned.dat" /* List of banned sites & users */
#define NOTE_FILE	DATA_DIR "notes.dat"	/* For 'notes'			*/
#define CLAN_FILE       DATA_DIR "clan.dat"      /* For 'clans'                  */
#define SOCIAL_FILE	DATA_DIR "social.dat"	/* For 'socials'		*/
#define RACE_FILE	DATA_DIR "race.dat"		/* For 'races'		*/
#define SHUTDOWN_FILE	DATA_DIR "shutdown.txt"	/* For 'shutdown'		*/
#define DOWN_TIME_FILE  DATA_DIR "time.txt"      /* For automatic shutdown       */
#define USERLIST_FILE   DATA_DIR "users.txt"     /* Userlist -- using identd TRI */
#define AUTH_LIST       DATA_DIR "auth.txt"      /* List of who auth who         */
#define PLAYERLIST_FILE DATA_DIR "player.lst"    /* Player List 			*/
#define HELP_LIST	HELP_DIR "help.lst"	/* List of areas		*/
#define NEWBIE_FILE     HELP_DIR "newbie.hlp"    /* Newbie help file		*/
#if defined( HOTREBOOT )
#define HOTREBOOT_FILE 	DATA_DIR "hotreboot.dat"  /* temporary data file used 	*/
#endif
/*
...
void	act	         args( ( int AType, const char *format, CHAR_DATA *ch,
				...
				int type ) );
const char *LOG_FILE(int port, bool old);
...
void    change_dimension args( ( CHAR_DATA *ch, int dimension ) );
...
bool	is_who		args( ( CHAR_DATA *ch, CHAR_DATA *victim ) );
...
bool    check_for_worn          args ( ( CHAR_DATA *ch, int vnum ) );
...
extern const struct flag_type   mecharmor_flags[];
...
extern const struct flag_type	bionic_loc_flags[];
...
extern const struct flag_type   movement_flags[];
